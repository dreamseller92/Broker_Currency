...
-- ПВП активности
	...
	{itemId = 43589, countFunc = function() return GetItemCount(43589) end},			--  Почетный знак Озера Ледяных Оков
--[[
--Мусор
...
-- Проф токены
	{itemId = 43016, countFunc = function() return GetItemCount(43016) end},			--  Даларанская кулинарная награда
	{itemId = 41596, countFunc = function() return GetItemCount(41596) end},			--  Даларанский знак ювелира
-- Другие токены
	{itemId = 43228, countFunc = function() return GetItemCount(43228) end},			--  Осколок каменного хранителя
	{itemId = 37836, countFunc = function() return GetItemCount(37836) end},			--  Монеты торговой компании
-- Турнир
	{itemId = 44990, countFunc = function() return GetItemCount(44990) end},			--  Печать чемпиона
	{itemId = 46114, countFunc = function() return GetItemCount(46114) end},			--  Удостоверение чемпиона
-- Ивенты
	{ itemId = 21100, countFunc = function() return GetItemCount(21100, true) end }, -- Монета Наследия
	{ itemId = 37829, countFunc = function() return GetItemCount(37829, true) end }, -- Токены пивного фестиваля
	{ itemId = 49927, countFunc = function() return GetItemCount(49927, true) end }, -- Любовная лихорадка
	{ itemId = 156008, countFunc = function() return GetItemCount(156008) end }, -- Обрамленный снег
-- СоСирус
	{ itemId = 160000, countFunc = function() return GetItemCount(160000) end }, --  Очки доблести
	{ itemId = 280512, countFunc = function() return GetItemCount(280512) end }, --  Жетон воина Запределья
	{ itemId = 280511, countFunc = function() return GetItemCount(280511) end }, --  Монета удачи Джулии
	{ itemId = 280510, countFunc = function() return GetItemCount(280510) end }, --  Почетный знак Расколотого Солнца
	{ itemId = 280510, countFunc = function() return GetItemCount(153610) end }, --  Рекомендательный значок Тол'Гарода
	{ itemId = 58020, countFunc = function() return GetItemCount(58020) end }, --  [Кредиты дельца Элисандра]

-- Эмблемки за убийства
	{ itemId = 280519, countFunc = function() return GetItemCount(280519) end }, -- Эмблема Ренегата
	{ itemId = 280518, countFunc = function() return GetItemCount(280518) end }, -- Эмблема Альянса
	{ itemId = 280517, countFunc = function() return GetItemCount(280517) end }, -- Эмблема Орды
-- Доп спеки
	{ itemId = 100584, countFunc = function() return GetItemCount(100584) end }, -- Кристалл расширения памяти
	{ itemId = 100585, countFunc = function() return GetItemCount(100585) end }, -- Превосходный кристалл расширения памяти
}
